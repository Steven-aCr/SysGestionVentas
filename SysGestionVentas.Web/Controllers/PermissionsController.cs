...
namespace SysGestionVentas.Web.Controllers
{
    public class PermissionsController : Controller
    {
        ...
        public PermissionsController(DbContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PermissionId,Name,Description,CreatedAt,IsActive")] Permission permission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PermissionId,Name,Description,CreatedAt,IsActive")] Permission permission)
        {
